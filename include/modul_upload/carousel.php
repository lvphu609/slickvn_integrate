	...
	if(isset($_POST) and $_SERVER['REQUEST_METHOD'] == "POST")
		{
            ...
            //  date_default_timezone_set('Australia/Melbourne');
              ...
              $date_string=$date;
							$actual_image_name ="carousel_".uniqid($date_string).".".$ext;
              ...
              $url_image=$url.$actual_image_name;
							...
							//	mysql_query("UPDATE users SET profile_image='$actual_image_name' WHERE uid='$session_id'");
									...
									echo "
                                 <img src='".$url_image."'  class='preview' style='width:661px; height:604px;'>";
								  echo'<input type="hidden" value="'.$actual_image_name.'" id="image_carousel_post">';
