...
//        var_dump($list_comment);
        foreach ($list_comment as $comment) {
            ...
            $comment_detail = array(
                                    ...
                                    User_enum::AVATAR                => $user[$comment['id_user']]['avatar'],
                                    ...
                                    Comment_enum::NUMBER_LIKE        => $this->UserModel->countUserLogByAction(array ( UserLogEnum::ID_ASSESSMENT => $comment['_id']->{'$id'}, 
                                                                                                                        UserLogEnum::ACTION        => Common_enum::LIKE_COMMENT
                                                                                                                        )),
                                    //  Number SHARE of Comment
                                    Comment_enum::NUMBER_SHARE        => $this->UserModel->countUserLogByAction(array ( UserLogEnum::ID_ASSESSMENT => $comment['_id']->{'$id'}, 
...
?>
>>>>>>> 120638e544bfaf8a47cfc674889908eb891aac56
