...
<div id="custom_other_criteria">
  <div id="content_custom_other_criteria">
   <div class="custom_other_criteria_title">
     <span style="font-size: 15px;"><div class=member_page_text">Tùy chỉnh > Quản lý mục tìm kiếm > Các tiêu chí khác</div></span>
   </div>
...
<!--       <li class="code_member">
       ...
       <li class="name_member">
         <span class="index_bole">Các tiêu chí</span>
         <div class="line_index"></div>
       </li>
<!--       <li class="job_member">
...
foreach ($other_criteria_list as $value){
...
<script>
  ...
  function add_item(object){
    ...
    var url=$("#hidUrl").val();
    var url_api=url+"index.php/admin/admin_controller/custom_other_criteria_add";
    var stt_item=parseInt($(object).closest('#custom_other_criteria').find('ul').last().find('#stt_item').text());
      var data={
    ...
    $.ajax({
          ...
          success: function(data){
            ...
            setTimeout(function(){
               $('#custom_other_criteria').find('#div_save_success').remove();
            },1000);
  ...
  function save_item(object){
   ...
   var url=$("#hidUrl").val();
   var url_api=url+"index.php/admin/admin_controller/custom_other_criteria_edit";
     var data={
  ...
  function delete_item(object){
      ...
      var url=$("#hidUrl").val();
      var url_api=url+"index.php/admin/admin_controller/custom_other_criteria_delete";
