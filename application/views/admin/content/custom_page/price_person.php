...
<div id="custom_price_person">
  <div id="content_custom_price_person">
   <div class="custom_price_person_title">
     <span style="font-size: 15px;"><div class=member_page_text">Tùy chỉnh > Quản lý mục tìm kiếm > Giá trung bình</div></span>
   </div>
...
<!--       <li class="code_member">
       ...
       <li class="name_member">
         <span class="index_bole">Giá trung bình người</span>
         <div class="line_index"></div>
       </li>
<!--       <li class="job_member">
...
foreach ($price_person_list as $value){
...
<script>
  ...
  function add_item(object){
    ...
    var url=$("#hidUrl").val();
    var url_api=url+"index.php/admin/admin_controller/custom_price_person_add";
    var stt_item=parseInt($(object).closest('#custom_price_person').find('ul').last().find('#stt_item').text());
      var data={
    ...
    $.ajax({
          ...
          success: function(data){
            ...
            setTimeout(function(){
               $('#custom_price_person').find('#div_save_success').remove();
            },1000);
  ...
  function save_item(object){
   ...
   var url=$("#hidUrl").val();
   var url_api=url+"index.php/admin/admin_controller/custom_price_person_edit";
     var data={
  ...
  function delete_item(object){
      ...
      var url=$("#hidUrl").val();
      var url_api=url+"index.php/admin/admin_controller/custom_price_person_delete";
