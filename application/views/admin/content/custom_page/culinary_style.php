...
<div id="custom_culinary_style">
  <div id="content_custom_culinary_style">
   <div class="custom_culinary_style_title">
     <span style="font-size: 15px;"><div class=member_page_text">Tùy chỉnh > Quản lý mục tìm kiếm >Phong cách ẩm thực</div></span>
   </div>
...
<!--       <li class="code_member">
       ...
       <li class="name_member">
         <span class="index_bole">Phong cách ẩm thực</span>
         <div class="line_index"></div>
       </li>
<!--       <li class="job_member">
...
<script>
  ...
  function add_item(object){
    ...
    var url=$("#hidUrl").val();
    var url_api=url+"index.php/admin/admin_controller/custom_culinary_style_add";
    var stt_item=parseInt($(object).closest('#custom_culinary_style').find('ul').last().find('#stt_item').text());
      var data={
    ...
    $.ajax({
          ...
          success: function(data){
            ...
            setTimeout(function(){
               $('#custom_culinary_style').find('#div_save_success').remove();
            },1000);
  ...
  function save_item(object){
   ...
   var url=$("#hidUrl").val();
   var url_api=url+"index.php/admin/admin_controller/custom_culinary_style_edit";
     var data={
  ...
  function delete_item(object){
      ...
      var url=$("#hidUrl").val();
      var url_api=url+"index.php/admin/admin_controller/custom_culinary_style_delete";
