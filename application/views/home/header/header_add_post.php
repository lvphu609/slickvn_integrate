...
<head>
    ...
    <link type="text/css" href="<?php echo $url; ?>/includes/css/common/add_post.css" rel="stylesheet" /> 
...
<div id="remove_disable_screen" class="">
  <div id="remove_image_load" class="">
  </div>
</div>