...
<head>
    ...
    <link type="text/css" href="<?php echo $url; ?>/includes/css/common/menu.css" rel="stylesheet" /> 
     <link type="text/css" href="<?php echo $url; ?>/includes/css/common/detail_restaurant.css" rel="stylesheet" />
    <link type="text/css" href="<?php echo $url; ?>/includes/css/common/slide_show_detail_restaurant.css" rel="stylesheet" />
