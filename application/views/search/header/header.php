...
<head>
    ...
    <link type="text/css" href="<?php echo $url; ?>/includes/css/common/search/location_page.css" rel="stylesheet" />
    <link type="text/css" href="<?php echo $url; ?>/includes/css/common/search/result_search.css" rel="stylesheet" />
    <link type="text/css" href="<?php echo $url; ?>/includes/css/common/search/result_search_post.css" rel="stylesheet" />
