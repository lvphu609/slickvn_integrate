...
<head>
    ...
    <link type="text/css" href="<?php echo $url; ?>/includes/css/common/terms_slick/location_page.css" rel="stylesheet" />
    <link type="text/css" href="<?php echo $url; ?>/includes/css/common/terms_slick/content.css" rel="stylesheet" />
